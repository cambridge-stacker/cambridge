...
HighscoresScene = require "scene.records.highscores"
ReplaySelectScene = require "scene.records.replay_select"
PlayerCardScene = require "scene.records.player_card"
RecordsScene = require "scene.records.records"
